export type Language = 'en' | 'ar' | 'fa' | 'fr' | 'es';
...
export const translations: Record<Language, Record<string, string>> = {
  ...
  fa: {
    ...
    // Hero
    'hero.title': 'Nibiru93.net',
    'hero.subtitle': 'جایی که داستان‌ها از جهان فراتر می‌روند',
    'hero.description': 'داستان‌های حماسی را کشف کنید، افسانه‌های خود را بنویسید و دفتر خاطرات خصوصی خود را در ستارگان نگه دارید.',
    'hero.explore': 'کاوش رمان‌ها',
    'hero.start_writing': 'شروع نوشتن',
    ...
    'auth.display_name': 'نام نمایشی',
    'auth.forgot_password': 'رمز عبور را فراموش کردید؟',
    'auth.no_account': 'حساب ندارید؟',
    'auth.have_account': 'حساب دارید؟',
    'auth.password_requirements': 'رمز عبور باید حداقل ۸ کاراکتر با حروف بزرگ، کوچک و عدد باشد',
    'auth.passwords_not_match': 'رمزهای عبور مطابقت ندارند',
    'auth.welcome_back': 'خوش آمدید',
    'auth.join_us': 'به کیهان بپیوندید',
    
    // Novels
    'novels.featured': 'رمان‌های ویژه',
    'novels.trending': 'پرطرفدار',
    'novels.latest': 'آخرین به‌روزرسانی‌ها',
    'novels.read_more': 'بیشتر بخوانید',
    'novels.chapters': 'فصل‌ها',
    'novels.views': 'بازدیدها',
    
    // Diary
    'diary.title': 'دفتر خاطرات کیهانی من',
    'diary.new_entry': 'ورودی جدید',
    'diary.mood': 'حال',
    'diary.private': 'خصوصی',
    'diary.save': 'ذخیره',
    'diary.delete': 'حذف',
    'diary.edit': 'ویرایش',
    'diary.empty': 'دفتر خاطرات شما خالی است. اولین ورودی خود را بنویسید!',
